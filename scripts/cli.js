...
const contractABI = require("../artifacts/contracts/Surgegateway.sol/Surgegateway.json").abi;

program
    .name("surgegateway-cli")
    .description("CLI tool for Surgegateway smart contract")
    .version("1.0.0");
