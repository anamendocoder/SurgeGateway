 ...
 * This file demonstrates how to integrate Surgegateway with a web frontend
 */

// For React/Vue/Angular applications
export class SurgegatewayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SurgegatewayClient(provider, contractAddress);
